    ...
    if not args.sharelink:
        ...
        with ThreadPoolExecutor(max_workers=max_workers) as executor:
            while True:
                ...
                def upload_file_task(local_path, remote_path):
                    result = upload_file(local_path, remote_path, args.chunk, args.step)
                ...
                def get_session_task(task):
                    ...
                    if status == 'good':
                        upload_file_task(local_path, remote_path,)
                    elif status == 'sleep':
                        q.put(task)
                        ...
                        executor.submit(
                            upload_file, local_path, remote_path, args.chunk, args.step
                        )
