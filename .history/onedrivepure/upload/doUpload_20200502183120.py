        ...
        with ThreadPoolExecutor(max_workers=args.workers) as executor:
            while True:
                while globle_sleep_time > 0:
                    ...
                    with tqdm(desc=get_now_time(),postfix=[message.format(sleep_time)],bar_format=bar_format) as bar:
                ...
                def upload_file_task(task):
                    result = upload_file(
                        *task, args.chunk, args.step
                    )
